#manage.py is the most important file as it manages how the project will run

#downloading all the libraries we need
...
#FlaskGroup helps us to create commands for managing the application
cli = FlaskGroup(create_app=create_app)

#the dictionary conatins the seeded data for the database
user_json = [
	{
		"name": "John Doe",
...
#re-enters dummy data into the db
def seeder():
...
#helps us to call rsd() function directly through terminal
@cli.command()

#calling reacreate_db and seeder function
def rsd():
